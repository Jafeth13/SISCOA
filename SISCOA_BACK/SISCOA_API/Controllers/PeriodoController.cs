...
namespace SISCOA_API.Controllers
{
    ...
    public class PeriodoController : ApiController
    {
        ...
        private readonly PeriodoService service = new PeriodoService(new PeriodoRepository(SISCOA_Context.Create()));
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        [HttpPost]
        public async Task<IHttpActionResult> Post(TSISCOA_Periodo_DTO DTO)
        {
        ...
        [HttpPut]
        [ResponseType(typeof(TSISCOA_Periodo_DTO))]
        public async Task<IHttpActionResult> Put(TSISCOA_Periodo_DTO DTO, int id)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
