...
@Component({
  selector: 'app-control-ofice-new',
  templateUrl: './control-ofice-new.component.html',
  styleUrls: ['./control-ofice-new.component.css']
})
export class ControlOficeNewComponent implements OnInit {
