...
DROP TABLE [CONTROL].[TSISCOA_EstadoControl]
...
CREATE TABLE CONTROL.TSISCOA_EstadoControl
(
	ID INT PRIMARY KEY IDENTITY(1,1),
	FK_TN_ESTADO_SISCOA_EstadoControl INT,
	FK_TN_CONTROL_SISCOA_EstadoControl INT,
	FOREIGN KEY (FK_TN_ESTADO_SISCOA_EstadoControl) REFERENCES [CONTROL].[TSISCOA_Estado](ID),
	FOREIGN KEY (FK_TN_CONTROL_SISCOA_EstadoControl) REFERENCES [CONTROL].[TSISCOA_Control](ID)
)
